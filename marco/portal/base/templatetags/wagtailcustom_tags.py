# Thanks to Mike 'Pomax' Kamermans for the below solution for auto-adding tags to RichText content headers
# As described here: https://stackoverflow.com/a/55128373/706797
...
def anchored_richtext(value):
    if isinstance(value, RichText):
        ...
        if isinstance(value, str):
            ...
            html = re.sub(heading_re, add_id_attribute, html)
        else:
...
def add_id_attribute(match):
    ...
    return f'<h{n}><span id="{id}" class="anchor_tag_buffer"></span>{text_content}</h{n}>'
